...
namespace HiddenVilla_Server.Service
{
    public class FileUpload : IFileUpload
    {
        ...
        // private readonly IHttpContextAccessor _httpContextAccessor; causing error in Azure
        private readonly IConfiguration _configuration;

        // removed this:  IHttpContextAccessor httpContextAccessor
        ...
        {
            try //dont understand this code well
            {
                ...
                //not working correctly with Azure
